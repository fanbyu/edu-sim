...
> 基于 IRT 和心理测量学的智能教育仿真平台，为个性化教学提供数据驱动的决策支持。
...
Edu-Sim 是一个专业的教育仿真系统，通过结合**项目反应理论（IRT）**、**心理特征建模**和**多智能体仿真**，帮助教育工作者：
...
✅ **科学的教育建模** - 基于 IRT 理论和心理测量学  
✅ **完整的知识图谱** - 持久化存储 + 交互式可视化  
✅ **智能干预推荐** - 自适应学生状态的策略推荐  
✅ **通用 LLM 支持** - Qwen、豆包、OpenAI 等多提供商  
✅ **灵活的架构设计** - 分层架构 + 多后端支持  
